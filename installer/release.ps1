...
#   3) csproj <Version> 을 읽어 installer\output\OctoCapture-Setup-<버전>.exe 생성
#   4) 프로젝트 저장소(kyh-octo/OctoCapture)에 태그 v<버전> + GitHub 릴리스 생성 (이미 있으면 설치 파일만 교체)
